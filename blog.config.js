const BLOG = {
  ...
  socialLink: 'https://grupopurim.com.br',
  seo: {
  ...
  analytics: {
    provider: 'G-RNKHNQ00RE', // Currently we support Google Analytics and Ackee, please fill with 'ga' or 'ackee', leave it empty to disable it.
    ackeeConfig: {
  ...
  comment: {
    ...
    gitalkConfig: {
      repo: '', // The 746a3ca4-9e9b-485c-825d-7bd8fae84343repository of store comments
      owner: '',
      admin: [],
      clientID: '',
      clientSecret: '',
    ...
    cusdisConfig: {
      appId: '746a3ca4-9e9b-485c-825d-7bd8fae84343', // data-app-id
