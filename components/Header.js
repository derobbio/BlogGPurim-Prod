...
const NavBar = () => {
  ...
  const links = [
    { id: 0, name: locale.NAV.PRINCIPAL, to: "https://grupopurim.com.br", show: true},
...
const HeaderName = forwardRef(function HeaderName ({ siteTitle, siteDescription, postTitle, onClick }, ref) {
  return (
    <p
      ...
      onClick={onClick}
    >
      {postTitle && <span className="post-title vertical row-start-1 col-start-1">{postTitle}</span>}
      <span className="row-start-1 col-start-1 vertical">
